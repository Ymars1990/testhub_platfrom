...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'collections',
                name: 'KnowledgeBaseCollections',
                component: () => import('@/views/knowledge-base/CollectionList.vue')
            },
            {
                path: 'documents',
            ...
            {
                path: 'query-logs',
                name: 'KnowledgeBaseQueryLogs',
                component: () => import('@/views/knowledge-base/QueryLogs.vue')
            }
        ]
    },
    {
