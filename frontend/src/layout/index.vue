    ...
    <el-container>
      ...
      <el-aside width="240px">
        ...
        >
          ...
          <!-- 知识库模块菜单 -->
          <template v-else-if="currentModule === 'knowledge-base'">
            <el-menu-item index="/knowledge-base/collections">
              <el-icon><Collection /></el-icon>
              <span>{{ $t('menu.knowledgeCollections') }}</span>
            </el-menu-item>
            <el-menu-item index="/knowledge-base/documents">
              <el-icon><Document /></el-icon>
              <span>{{ $t('menu.knowledgeDocuments') }}</span>
            </el-menu-item>
            <el-menu-item index="/knowledge-base/search">
              <el-icon><Search /></el-icon>
              <span>{{ $t('menu.knowledgeSearch') }}</span>
            </el-menu-item>
            <el-menu-item index="/knowledge-base/query-logs">
              <el-icon><Timer /></el-icon>
              <span>{{ $t('menu.knowledgeQueryLogs') }}</span>
            </el-menu-item>
          </template>
...
import {
  ...
  Odometer, Timer, Setting, AlarmClock, Bell, Aim, Edit, Cpu, ArrowDown, Cellphone, Connection, FolderOpened, Search
...
const moduleName = computed(() => {
  const map = {
    ...
    'knowledge-base': t('modules.knowledgeBase'),
...
const breadcrumbTitle = computed(() => {
  const routeMap = {
    ...
    // 知识库
    '/knowledge-base/collections': t('menu.knowledgeCollections'),
    '/knowledge-base/documents': t('menu.knowledgeDocuments'),
    '/knowledge-base/search': t('menu.knowledgeSearch'),
    '/knowledge-base/query-logs': t('menu.knowledgeQueryLogs'),
